              ...
              (
                <div className="bg-neutral-200 w-3xl text-[#2d5a2d] flex flex-col h-screen">
                  ...
                  <div className="flex-1 p-6 overflow-y-auto text-[#16730F]">
                    ...
                    <div className="text-[#1A3E32] font-semibold text-[9px] mt-8">
                      <p>JOB ROLE</p>
                      <p className="text-[#16730F] text-[10px]">Graphics Designer</p>
                      <p className="mt-4">DATE/TIME SENT</p>
                      <p className="text-[#16730F]">15th July,  1:50pm <span className="text-neutral-400 text-[7px]">UTC</span></p>
                    </div>
                    <div className="mt-6">
                      <p className="text-[#1A3E32] text-[10px] mb-2 font-semibold">STATUS</p>
                      <div className="flex gap-4">
                        <button className="w-[130px] p-2 font-semibold text-[#1A3E32] bg-[#FFB547] rounded-sm">Waiting</button>
                        <button className="w-[130px] p-2 font-semibold text-[#16730F] bg-white border-[#16730F] border-2 rounded-sm">Accepted</button>
                        <button className="w-[130px] p-2 font-semibold text-[#EB5757] bg-white border-[#EB5757] border-2 rounded-sm">Expired</button>
                      </div>
                    </div>
                  </div>
                  {/* Message Input */}
